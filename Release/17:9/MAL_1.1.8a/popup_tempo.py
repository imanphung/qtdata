...
parser.add_argument('-r', '--reset', help = 'Run Reset', default = 'off')
parser.add_argument('-temponotepid', '--temponote-pid', help = 'GET Tempo Note PID', default = -1)
parser.add_argument('-capimgspid', '--capimgs-pid', help = 'GET Capture Image PID', default = -1)
...
def create_window_reset():
    ...
    layout = [
        [
            ...
            sg.Button('30 min', key = '-30MIN-', size = (10, 1))
        ]
    ]
    window = sg.Window(
        'Reset',
...
if args.reset == 'on':
#    temponote_pid = args.temponote_pid
#    capimgs_pid = args.capimgs_pid
    run_popup_reset()
